        ...
        <h2 class="py-4">
            <Badge bg="danger">Our Blogs</Badge>
              ...
              <div class="col-md-12">
                    ...
                    <div>
                            <StaticImage src="../../../images/learning-education-ideas-insight-intelligence-study-concept.jpg" style={{height:"500px",width:"100%",objectFit:"cover",opacity:"0.4"}} alt="erainterfaces-lrs-image"/>
                        </div>
              ...
              {sliceData.map((item,index)=>{
                  return(
                    ...
                    <div class="card-content">
                        <div class="card-img">
                            <img src={item.img}  alt="erainterfaces-our-blogs-images"/>   
                        </div>
                        <div class="card-desc">
                            <h3>{item.title}</h3>
                            <p>{item.Desc}</p>
            ...
            <div className=" text-center">
              <a href="/blogs" class="btn btn-danger text-white btn-lg">View Blogs</a>  
            </div>
             </div>
             </div>
             </div>
