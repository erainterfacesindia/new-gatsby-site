...
const BlogSection = ({data}) => {
    ...
    const blogListLength =OurblogData.CardData;
  ...
  <Badge bg="danger">BLOGS</Badge>
        ...
        {/* <p><Link to="/blog">View Blog</Link></p> */}
              <div class="col-md-12">
                    ...
                    <div>
                            <StaticImage src="../../../images/learning-education-ideas-insight-intelligence-study-concept.jpg"  style={{height:"500px",width:"100%",objectFit:"cover",opacity:"0.8"}} alt="erainterfaces-learning-record-image"/>
                        </div>
