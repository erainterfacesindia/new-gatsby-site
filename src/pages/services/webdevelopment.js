...
const development = () => {
    ...
    <div class="row">
    <h2 class="py-5">
  <Badge bg="danger">WEB DEVELOPMENT</Badge>
                {/* <span class="underline"></span>  */}
              </h2> 
        <div class="col-md-12 mb40">
        <article class=" text-center"> 
                <StaticImage src="../../images/services/development.webp" alt="" class=" img-fluid" style={{height:"500px",width:"100%",objectFit:"cover"}}/>
